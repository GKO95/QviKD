...
namespace QviKDLib.WinAPI
{
    public static class Dxva2
    {
        ...
        [DllImport("Dxva2.dll", CharSet = CharSet.Ansi, SetLastError = true, EntryPoint = "DestroyPhysicalMonitor")]
        internal static extern bool DestroyPhysicalMonitor(HANDLE hMonitor);

        [DllImport("Dxva2.dll", CharSet = CharSet.Ansi, SetLastError = true, EntryPoint = "DestroyPhysicalMonitors")]
